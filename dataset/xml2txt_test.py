...
def extract(filename):
	tree = ET.parse('./rawdata/test.xml')
	root = tree.getroot()
	...
	#	X = re.sub('<code>|</code>','',X)
		...
		if X != "":
			...
			if out_title != "None":
				if count < 170 and X != " ":
					X = str(score) + "******" + X + out_title.lower() + "******" + out_title.lower() + "******" + out_time + "******"+ str(1) + "******CA"
					out.write(X+'\n')
					count = count + 1
				elif count >= 170 and count <  340 and X != " ":
					X = str(score) + "******" + X + out_title.lower() + "******" + out_title.lower() + "******" + out_time + "******"+ str(2) + "******CA"
					out.write(X+'\n')
					count = count + 1
				elif X != " ":
					X = str(score) + "******" + X + out_title.lower() + "******" + out_title.lower() + "******" + out_time + "******"+ str(3) + "******CA"
					out.write(X+'\n')
					count = count + 1
			else:
				if count < 170 and X != " ":
					X = str(score) + "******" + X + "******" + out_title.lower() + "******" + out_time + "******"+ str(1) + "******CA"
					out.write(X+'\n')
					count = count + 1
				elif count >= 170 and count < 340 and X != " ":
					X = str(score) + "******" + X + "******" + out_title.lower() + "******" + out_time + "******"+ str(2) + "******CA"
					out.write(X+'\n')
					count = count + 1
				elif X != " ":
					X = str(score) + "******" + X + "******" + out_title.lower() + "******" + out_time + "******"+ str(3) + "******CA"
					out.write(X+'\n')
					count = count + 1
